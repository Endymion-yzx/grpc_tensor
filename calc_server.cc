...
private:
	...
	public:
		...
		CallData(Calc::AsyncService* service, ServerCompletionQueue* cq):
		...
		void Proceed() {
			if (status_ == CREATE) {
				...
				service_->RequestCalcArea(&ctx_, &circle, &responder_, 
						cq_, cq_, this);
				...
				status_ = FINISH;
				responder_.Finish(area, Status::OK, this);
			} else {
	...
	private:
		...
		ServerAsyncResponseWriter<Area> responder_;
